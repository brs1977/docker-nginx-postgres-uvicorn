...
def test_read_user(test_app, api_url, monkeypatch):
    test_data = {'id': 1, 'role_id': 4, 'username': 'username', 'password': 'adm', 'email': 'email@email.com', 'fio': 'fio', 'is_active': True }
...
def test_read_all_users(test_app, api_url, monkeypatch):
    test_data = [
        {'id': 1, 'role_id': 4, 'username': 'username', 'password': 'adm', 'email': 'email@email.com', 'fio': 'fio', 'is_active': True },
        {'id': 2, 'role_id': 4, 'username': 'username', 'password': 'adm', 'email': 'email@email.com', 'fio': 'fio', 'is_active': True }
    ]
...
def test_update_user(test_app, api_url, monkeypatch):
    test_update_data = {'id': 1, 'role_id': 4, 'username': 'username', 'password': 'adm', 'email': 'email@email.com', 'fio': 'fio', 'is_active': True }
...
@pytest.mark.parametrize(
    ...
    [
        [1, {}, 422],
        [999, {'role_id': 4, 'username': 'username', 'password': 'adm', 'email': 'email@email.com', 'fio': 'fio', 'is_active': True }, 404],
        [0,   {'role_id': 4, 'username': 'username', 'password': 'adm', 'email': 'email@email.com', 'fio': 'fio' }, 422],
    ]
)
...
def test_remove_user(test_app, api_url, monkeypatch):
    test_data = test_data = {'id': 1, 'role_id': 4, 'username': 'username', 'password': 'adm', 'email': 'email@email.com', 'fio': 'fio', 'is_active': True }
